...
# ``bhf_project_1/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-bhf_project_1-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_demo.bhf_project_1-model", label="Full (Three-Level) Model Name"
)
