...
Opening a pull request will trigger a[workflow](../.github/workflows/bhf_project_1-run-tests.yml) 
...
Links:
* [Staging model in UC](https://fe-vm-sharath-ml-ops.cloud.databricks.com/explore/data/models/staging/bhf_project_1/bhf_project_1-model)
* [Prod model in UC](https://fe-vm-sharath-ml-ops.cloud.databricks.com/explore/data/models/prod/bhf_project_1/bhf_project_1-model)
. 
