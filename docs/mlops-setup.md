...
git add README.md docs .gitignore bhf_project_1/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://fe-vm-sharath-ml-ops.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://fe-vm-sharath-ml-ops.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[bhf_project_1/databricks.yml](../bhf_project_1/databricks.yml) file.
...
Follow the instructions in [bhf_project_1/resources/README.md](../bhf_project_1/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../bhf_project_1/resources/README.md)  to propose, test, and deploy
